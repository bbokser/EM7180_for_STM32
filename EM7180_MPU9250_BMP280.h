/*
 * EM7180_MPU9250_BMP280.h
 *
 *  Created on: May 1, 2019
 *      Author: Ben
 */

#ifndef EM7180_MPU9250_BMP280_H_
#define EM7180_MPU9250_BMP280_H_
...
#define M24512DFM_DATA_ADDRESS   0x50<<1  // Address of the 500 page M24512DRC EEPROM data buffer, 1024 bits (128 8-bit bytes) per page
#define M24512DFM_IDPAGE_ADDRESS 0x58<<1   // Address of the single M24512DRC lockable EEPROM ID page
#define MPU9250_ADDRESS          0x68<<1   // Device address of MPU9250 when ADO = 0
#define AK8963_ADDRESS           0x0C<<1   // Address of magnetometer
#define BMP280_ADDRESS           0x76<<1   // Address of BMP280 altimeter when ADO = 0
...
typedef struct EM7180{
	//uint8_t mode;	//default mode
	//short acc_offset[3];
	//short mag_offset[3];
	float gyr_offset[3];
	//short radius[2];
...
#endif /* EM7180_MPU9250_BMP280_H_ */
